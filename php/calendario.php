...
<body>
    ...
    <section class="container-fluid px-sm-3 px-0 mt-4 row mx-auto position-relative">
    <?php
        if(!isset($_SESSION['user'])){
            ...
            if($_SESSION["tipo"]!="Cliente"){
                echo "
                <div>
                    <span class='desactivado d-inline-block'><a class='mx-auto mx-md-0 d-inline-block btn btn-primary mb-2' target='_blank' href='citas_pdf.php'>PDF Citas</a></span>
                </div>
                ";
            }

            echo "<div class='contenedor_tabla col-12 p-0'>
                <table>
                    <thead>
                        <tr>
                            <th>Fecha</th>
